...
{
    [ComVisible(true)]
    public class MyModifiedIconOverlayHandler : SharpIconOverlayHandler
    {
                ...
                using (SQLiteConnection conn = new SQLiteConnection("Data Source =" + dbPath))
                {
                        ...
                        || path.StartsWith(Path.Combine(rootDir, @"共享空间\")))
                    {
                        ...
                        if (reader.Read())
                        {
                            ...
                            if (t.Equals(f.LastWriteTime.ToString("yyyy-MM-dd HH:mm:ss")))
                            {
                                return false;
                            }
                            else
        ...
        {
            return Properties.Resources.ModifiedIcon;
        }
